...
function replaceIt() {
    ...
    theStory += exclamation + "! he exclaimed, as he " + pastVerb2 + " down the stairs to join the " + verb + " It was a  " + adjDance + " party.<br><br>";
    theStory += "Douglas danced the " + animal + " Dance, the " + city + " Shake, and took the prize for dancing the best celebrate " + noun + ".<br><br>";
    theStory += "Douglas danced very " + adverb + ".<br><br>";
